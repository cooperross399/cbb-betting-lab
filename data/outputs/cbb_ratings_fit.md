...
|:---|---:|---:|---:|:---|---:|:---|:---|:---|---:|---:|:---|:---|
| high_major | 61 | 687 | 96.5% | 16% / 37% / 8% | +3.84 | +2.70 to +4.98 | +1.82 to +5.86 | excludes zero after the family correction | 10.89 | +2.76 | +1.50 to +4.02 | +0.53 to +4.98 |
| mid_major | 131 | 1,387 | 94.7% | 17% / 38% / 8% | +1.83 | +1.07 to +2.59 | +0.49 to +3.17 | excludes zero after the family correction | 9.40 | +1.87 | +0.96 to +2.77 | +0.27 to +3.47 |
| low_major | 172 | 1,841 | 94.6% | 18% / 39% / 9% | -0.17 | -0.75 to +0.41 | -1.20 to +0.85 | **no demonstrated edge** | 9.24 | +2.86 | +2.11 to +3.61 | +1.54 to +4.18 |
| mixed | — | 804 | 62.2% | — / — / — | -3.39 | -4.57 to -2.20 | -5.48 to -1.29 | excludes zero after the family correction | 11.31 | +1.65 | +0.46 to +2.84 | -0.46 to +3.76 |
| POOLED | 365 | 4,719 | 87.1% | 18% / 38% / 8% | +0.45 | -0.13 to +1.03 | -0.57 to +1.47 | **no demonstrated edge** | 9.88 | +2.35 | +1.86 to +2.84 | +1.48 to +3.21 |
...
|:---|---:|---:|:---|:---|---:|:---|:---|---:|
| high_major | +12.36 | +5.58 | +4.52 to +6.63 | +3.71 to +7.44 | 475 | **no** | **no** | +6.78 |
| mid_major | +7.34 | +4.70 | +4.03 to +5.36 | +3.52 to +5.88 | 1,134 | **no** | **no** | +2.64 |
| low_major | +3.90 | +3.69 | +3.15 to +4.23 | +2.73 to +4.64 | 1,728 | yes | yes | +0.22 |
| unplaced | +7.87 | — | — | — | 0 | — | — | — |
