...
**Family correction: 95 cumulative hypotheses** in the experiment ledger, widening every 95% interval by x1.77. That is the ledger's **cumulative** count and never the day's — a search that runs every week is not twelve tests, it is twelve tests a week, forever. 32 of them are this run's own holdout looks: putting a discovery finding to the holdout **is** a second look and is counted as one.
...
| high_major | moneyline | -0.8% over 3,489 (no claim) | 2,021 | 253 | -8.0% | -17.8% to +1.7% | -25.2% to +9.2% | no demonstrated edge | **not enough evidence** |
...
| high_major | team_total | -5.7% over 1,261 (no claim) | 5,848 | 2,285 | -2.2% | -5.2% to +0.8% | -7.5% to +3.0% | no demonstrated edge | **nothing to replicate** |
| high_major | total_points | -3.1% over 7,316 (no claim) | 4,925 | 246 | -3.7% | -8.7% to +1.2% | -12.5% to +5.0% | no demonstrated edge | **nothing to replicate** |
...
| mid_major | moneyline | -4.4% over 6,702 (no claim) | 3,492 | 253 | -4.6% | -10.7% to +1.5% | -15.4% to +6.2% | no demonstrated edge | **not enough evidence** |
...
| high_major | spread | 2025 | 3,008 | 1,165 | -1.2% | -6.9% to +4.5% | -11.3% to +8.9% | nothing to replicate |
...
| high_major | team_total | 2025 | 2,875 | 133 | -1.8% | -5.9% to +2.4% | -9.1% to +5.6% | nothing to replicate |
| high_major | team_total | 2026 | 2,973 | 1,074 | -2.7% | -7.0% to +1.6% | -10.3% to +5.0% | nothing to replicate |
| high_major | total_points | 2025 | 2,619 | 127 | -4.8% | -11.7% to +2.1% | -17.0% to +7.3% | nothing to replicate |
| high_major | total_points | 2026 | 2,306 | 119 | -2.5% | -9.7% to +4.7% | -15.2% to +10.2% | nothing to replicate |
...
| mid_major | spread | 2026 | 3,984 | 124 | -2.5% | -7.6% to +2.6% | -11.5% to +6.5% | nothing to replicate |
...
| mid_major | team_total | 2026 | 4,968 | 125 | -6.6% | -10.2% to -3.1% | -12.9% to -0.4% | nothing to replicate |
| mid_major | total_points | 2025 | 4,180 | 129 | -8.2% | -13.5% to -2.9% | -17.6% to +1.2% | nothing to replicate |
...
| low_major | total_points | 2025 | 3,294 | 114 | -6.6% | -12.9% to -0.3% | -17.8% to +4.5% | nothing to replicate |
| low_major | total_points | 2026 | 3,975 | 1,589 | -4.0% | -9.0% to +1.0% | -12.9% to +4.8% | nothing to replicate |
...
|:---|---:|---:|---:|:---|:---|:---|
| high_major | 18,329 | 256 | -3.4% | -6.3% to -0.5% | -8.5% to +1.7% | no demonstrated edge |
...
|:---|---:|---:|---:|:---|:---|:---|
| moneyline | 8,443 | 277 | -6.7% | -11.1% to -2.3% | -14.5% to +1.1% | no demonstrated edge |
