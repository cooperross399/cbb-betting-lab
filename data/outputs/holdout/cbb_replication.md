...
**Family correction: 30 cumulative hypotheses** in the experiment ledger, widening every 95% interval by x1.60. That is the ledger's **cumulative** count and never the day's — a search that runs every week is not twelve tests, it is twelve tests a week, forever. 0 of them are this run's own holdout looks: putting a discovery finding to the holdout **is** a second look and is counted as one.
...
| mid_major | moneyline | -5.9% over 4,337 (no claim) | 2,279 | 2,278 | -1.4% | -8.7% to +5.9% | -13.2% to +10.3% | no demonstrated edge | **nothing to replicate** |
| mid_major | spread | -1.9% over 8,944 (no claim) | 5,478 | 130 | -1.5% | -6.4% to +3.3% | -9.3% to +6.2% | no demonstrated edge | **nothing to replicate** |
| mid_major | total_points | +0.3% over 9,166 (no claim) | 5,739 | 129 | -0.4% | -5.5% to +4.6% | -8.6% to +7.7% | no demonstrated edge | **nothing to replicate** |
| low_major | moneyline | -7.6% over 3,450 (no claim) | 1,134 | 108 | — | — | — | not enough evidence (1,134 held-out bets, below the 2,000 declared in advance) | **not enough evidence** |
| low_major | spread | -0.2% over 6,900 (no claim) | 2,612 | 108 | -0.2% | -6.3% to +5.9% | -10.0% to +9.6% | no demonstrated edge | **nothing to replicate** |
| low_major | total_points | -2.5% over 7,559 (no claim) | 2,973 | 1,087 | -12.1% | -18.1% to -6.0% | -21.8% to -2.4% | demonstrated deficit | **nothing to replicate** |
| unplaced | moneyline | — | 0 | 0 | — | — | — | — | **untestable** |
| unplaced | spread | — | 0 | 0 | — | — | — | — | **untestable** |
| unplaced | total_points | — | 0 | 0 | — | — | — | — | **untestable** |

**0 replicated, 0 did not replicate, 0 reversed, 4 not enough evidence, 5 nothing to replicate, 3 untestable.**
...
- **mid_major / moneyline — nothing to replicate**: 2024: the discovery window demonstrated nothing here (no demonstrated edge), so there is no result to reproduce. The held-out season is no demonstrated edge as well, over 2,279 bets.
...
|:---|---:|---:|---:|:---|:---|:---|
| high_major | 5,044 | 119 | -3.6% | -9.9% to +2.6% | -13.7% to +6.4% | no demonstrated edge |
| mid_major | 17,732 | 132 | -1.9% | -5.4% to +1.5% | -7.4% to +3.6% | no demonstrated edge |
| low_major | 8,692 | 1,343 | -6.4% | -10.4% to -2.4% | -12.8% to +0.0% | no demonstrated edge |
...
|:---|---:|---:|---:|:---|:---|:---|
| moneyline | 4,031 | 136 | -2.9% | -8.9% to +3.1% | -12.5% to +6.8% | no demonstrated edge |
| spread | 9,673 | 136 | -1.7% | -4.9% to +1.5% | -6.9% to +3.4% | no demonstrated edge |
| team_total | 7,419 | 134 | -5.1% | -7.6% to -2.6% | -9.1% to -1.0% | demonstrated deficit |
| total_points | 10,345 | 136 | -4.1% | -7.5% to -0.7% | -9.6% to +1.4% | no demonstrated edge |
| every market | 31,468 | 136 | -3.4% | -5.9% to -1.0% | -7.3% to +0.4% | no demonstrated edge |
