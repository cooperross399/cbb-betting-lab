...
| market_implied | 1 | +1.013 | +0.973 to +1.054 | +0.941 to +1.085 | 62,163 | 719 days | contains 1.0 — the de-vigged price is calibrated at this sample size, which is what makes the disagreement coefficient readable |
| disagreement | 0 | +0.088 | +0.013 to +0.163 | -0.046 to +0.221 | 62,163 | 6,268 games | no demonstrated edge |
...
- **against the de-vigged market:** the model's Brier advantage is -0.01686 over 62,163 wagers across 6,268 games, 95% interval -0.01987 to -0.01384, family-corrected -0.02221 to -0.01150 — demonstrated deficit.
- **against the raw, handicapped market:** the model's Brier advantage is -0.01663 over 62,163 wagers across 6,268 games, 95% interval -0.01965 to -0.01361, family-corrected -0.02199 to -0.01127 — demonstrated deficit.
...
- **against the de-vigged market:** the model's Brier advantage is -0.00971 over 137,296 wagers across 11,728 games, 95% interval -0.01172 to -0.00770, family-corrected -0.01328 to -0.00613 — demonstrated deficit.
- **against the raw, handicapped market:** the model's Brier advantage is -0.00962 over 137,296 wagers across 11,728 games, 95% interval -0.01164 to -0.00760, family-corrected -0.01321 to -0.00603 — demonstrated deficit.
...
| Term | Null | Coefficient | 95% interval | Family-corrected | Rows | Clusters | Reading |
|:---|---:|---:|:---|:---|---:|---:|:---|
| intercept | 0 | -0.021 | -0.046 to +0.004 | -0.065 to +0.024 | 94,182 | 9,084 games | contains zero |
| market_implied | 1 | +1.057 | +1.007 to +1.108 | +0.968 to +1.147 | 94,182 | 9,084 games | contains 1.0 — the de-vigged price is calibrated at this sample size, which is what makes the disagreement coefficient readable |
| disagreement | 0 | +0.046 | -0.064 to +0.156 | -0.149 to +0.242 | 94,182 | 645 days | no demonstrated edge |
...
- **against the de-vigged market:** the model's Brier advantage is -0.00801 over 94,182 wagers across 645 days, 95% interval -0.00985 to -0.00617, family-corrected -0.01128 to -0.00474 — demonstrated deficit.
- **against the raw, handicapped market:** the model's Brier advantage is -0.00776 over 94,182 wagers across 645 days, 95% interval -0.00961 to -0.00591, family-corrected -0.01104 to -0.00447 — demonstrated deficit.
...
- **against the de-vigged market:** the model's Brier advantage is -0.08451 over 20 wagers across 2 games, 95% interval -0.27866 to +0.10965, family-corrected -0.42957 to +0.26056 — not enough evidence (20 bets, below the 200 declared in advance).
- **against the raw, handicapped market:** the model's Brier advantage is -0.08603 over 20 wagers across 2 games, 95% interval -0.28132 to +0.10925, family-corrected -0.43311 to +0.26104 — not enough evidence (20 bets, below the 200 declared in advance).
...
| Term | Null | Coefficient | 95% interval | Family-corrected | Rows | Clusters | Reading |
|:---|---:|---:|:---|:---|---:|---:|:---|
| intercept | 0 | -0.027 | -0.039 to -0.015 | -0.049 to -0.006 | 293,661 | 27,082 games | excludes zero, below it — a level the de-vigged price does not account for, which is a fact about the fit rather than a claim about the model |
| market_implied | 1 | +1.071 | +1.046 to +1.095 | +1.027 to +1.115 | 293,661 | 27,082 games | excludes 1.0 (over-responsive) — the de-vigged price is not calibrated on this population, so read the disagreement coefficient only after understanding why |
| disagreement | 0 | +0.094 | +0.044 to +0.144 | +0.005 to +0.183 | 293,661 | 27,082 games | demonstrated edge |
...
- **against the de-vigged market:** the model's Brier advantage is -0.01068 over 293,661 wagers across 27,082 games, 95% interval -0.01195 to -0.00941, family-corrected -0.01294 to -0.00843 — demonstrated deficit.
...
| market_implied | 1 | +1.008 | +0.964 to +1.052 | +0.929 to +1.087 | 24,600 | 718 days | contains 1.0 — the de-vigged price is calibrated at this sample size, which is what makes the disagreement coefficient readable |
...
- **against the de-vigged market:** the model's Brier advantage is -0.02024 over 24,600 wagers across 6,122 games, 95% interval -0.02414 to -0.01635, family-corrected -0.02716 to -0.01332 — demonstrated deficit.
- **against the raw, handicapped market:** the model's Brier advantage is -0.02011 over 24,600 wagers across 6,122 games, 95% interval -0.02346 to -0.01676, family-corrected -0.02607 to -0.01416 — demonstrated deficit.
...
| market_implied | 1 | +1.096 | +1.055 to +1.137 | +1.023 to +1.169 | 51,053 | 11,315 games | excludes 1.0 (over-responsive) — the de-vigged price is not calibrated on this population, so read the disagreement coefficient only after understanding why |
| disagreement | 0 | +0.267 | +0.130 to +0.404 | +0.024 to +0.510 | 51,053 | 740 days | demonstrated edge |
...
- **against the de-vigged market:** the model's Brier advantage is -0.01222 over 51,053 wagers across 11,315 games, 95% interval -0.01498 to -0.00946, family-corrected -0.01712 to -0.00732 — demonstrated deficit.
- **against the raw, handicapped market:** the model's Brier advantage is -0.01233 over 51,053 wagers across 11,315 games, 95% interval -0.01461 to -0.01005, family-corrected -0.01638 to -0.00828 — demonstrated deficit.
...
| market_implied | 1 | +1.055 | +0.998 to +1.112 | +0.953 to +1.156 | 34,657 | 8,702 games | contains 1.0 — the de-vigged price is calibrated at this sample size, which is what makes the disagreement coefficient readable |
| disagreement | 0 | +0.177 | -0.003 to +0.358 | -0.144 to +0.499 | 34,657 | 644 days | no demonstrated edge |
...
- **against the de-vigged market:** the model's Brier advantage is -0.01019 over 34,657 wagers across 644 days, 95% interval -0.01270 to -0.00767, family-corrected -0.01466 to -0.00571 — demonstrated deficit.
- **against the raw, handicapped market:** the model's Brier advantage is -0.00991 over 34,657 wagers across 644 days, 95% interval -0.01191 to -0.00790, family-corrected -0.01347 to -0.00635 — demonstrated deficit.
...
- **against the de-vigged market:** the model's Brier advantage is -0.14294 over 6 wagers across 2 games, 95% interval -0.38981 to +0.10394, family-corrected -0.58171 to +0.29583 — not enough evidence (6 bets, below the 200 declared in advance).
- **against the raw, handicapped market:** the model's Brier advantage is -0.13092 over 6 wagers across 2 games, 95% interval -0.36990 to +0.10806, family-corrected -0.55565 to +0.29381 — not enough evidence (6 bets, below the 200 declared in advance).
...
- **against the de-vigged market:** the model's Brier advantage is -0.01338 over 110,316 wagers across 26,141 games, 95% interval -0.01510 to -0.01165, family-corrected -0.01644 to -0.01032 — demonstrated deficit.
- **against the raw, handicapped market:** the model's Brier advantage is -0.01331 over 110,316 wagers across 26,141 games, 95% interval -0.01474 to -0.01188, family-corrected -0.01585 to -0.01077 — demonstrated deficit.
