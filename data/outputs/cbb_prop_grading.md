...
- Family correction: 101 cumulative hypotheses (x1.7773), read from the experiment ledger at render time
...
|:---|---:|:---|:---|---:|---:|---:|:---|
| de-vig proportional / conditional | -0.0057 | -0.0103 to -0.0012 | -0.0139 to +0.0024 | 46,370 | 106 days | ±0.0082 | no demonstrated edge |
| **de-vig proportional / unconditional — HEADLINE, least favourable to the model** | -0.0057 | -0.0103 to -0.0012 | -0.0139 to +0.0024 | 46,370 | 106 days | ±0.0082 | no demonstrated edge |
| de-vig power / conditional | -0.0055 | -0.0102 to -0.0007 | -0.0139 to +0.0029 | 46,370 | 106 days | ±0.0084 | no demonstrated edge |
| de-vig power / unconditional | -0.0055 | -0.0102 to -0.0007 | -0.0139 to +0.0029 | 46,370 | 106 days | ±0.0084 | no demonstrated edge |
| control / conditional | +0.1130 | +0.0863 to +0.1396 | +0.0656 to +0.1603 | 46,370 | 541 athletes | ±0.0473 | demonstrated edge |
| control / unconditional | +0.1130 | +0.0863 to +0.1396 | +0.0656 to +0.1603 | 46,370 | 541 athletes | ±0.0473 | demonstrated edge |
...
| Comparison | Advantage (baseline − model log loss) | 95% interval | Family-corrected | Wagers | Clusters | Could detect | Reading |
|:---|---:|:---|:---|---:|---:|---:|:---|
| **de-vig proportional / conditional — HEADLINE, least favourable to the model** | -0.0045 | -0.0077 to -0.0014 | -0.0102 to +0.0011 | 74,174 | 124 days | ±0.0057 | no demonstrated edge |
| de-vig proportional / unconditional | -0.0045 | -0.0077 to -0.0014 | -0.0102 to +0.0011 | 74,174 | 124 days | ±0.0057 | no demonstrated edge |
...
| control / conditional | +0.1154 | +0.1018 to +0.1290 | +0.0912 to +0.1395 | 74,174 | 709 athletes | ±0.0242 | demonstrated edge |
| control / unconditional | +0.1154 | +0.1018 to +0.1290 | +0.0912 to +0.1395 | 74,174 | 709 athletes | ±0.0242 | demonstrated edge |
...
| Comparison | Advantage (baseline − model log loss) | 95% interval | Family-corrected | Wagers | Clusters | Could detect | Reading |
|:---|---:|:---|:---|---:|---:|---:|:---|
| de-vig proportional / conditional | -0.0058 | -0.0238 to +0.0123 | -0.0378 to +0.0263 | 2,060 | 101 athletes | ±0.0320 | no demonstrated edge |
| de-vig proportional / unconditional | -0.0058 | -0.0238 to +0.0123 | -0.0378 to +0.0263 | 2,060 | 101 athletes | ±0.0320 | no demonstrated edge |
| **de-vig power / conditional — HEADLINE, least favourable to the model** | -0.0065 | -0.0246 to +0.0116 | -0.0387 to +0.0257 | 2,060 | 101 athletes | ±0.0322 | no demonstrated edge |
| de-vig power / unconditional | -0.0065 | -0.0246 to +0.0116 | -0.0387 to +0.0257 | 2,060 | 101 athletes | ±0.0322 | no demonstrated edge |
| control / conditional | +0.0449 | -0.0010 to +0.0908 | -0.0367 to +0.1265 | 2,060 | 101 athletes | ±0.0816 | no demonstrated edge |
| control / unconditional | +0.0449 | -0.0010 to +0.0908 | -0.0367 to +0.1265 | 2,060 | 101 athletes | ±0.0816 | no demonstrated edge |
...
|:---|---:|:---|---:|:---|---:|---:|:---|
| player_points / high_major | 9,612 | de-vig proportional / unconditional | -0.0036 | -0.0246 to +0.0174 | 106 days | 33.7% | no demonstrated edge |
| player_rebounds / high_major | 7,400 | de-vig power / conditional | -0.0045 | -0.0175 to +0.0085 | 105 days | 38.7% | no demonstrated edge |
| player_assists / high_major | 6,040 | de-vig power / conditional | -0.0054 | -0.0216 to +0.0109 | 104 days | 52.2% | no demonstrated edge |
| player_threes / high_major | 4,304 | de-vig proportional / conditional | -0.0112 | -0.0271 to +0.0048 | 403 athletes | 49.5% | no demonstrated edge |
| player_steals / high_major | 3,720 | de-vig proportional / conditional | +0.0020 | -0.0118 to +0.0158 | 298 games | 89.0% | no demonstrated edge |
| player_turnovers / high_major | 3,904 | de-vig power / conditional | -0.0016 | -0.0157 to +0.0124 | 361 athletes | 100.0% | no demonstrated edge |
| player_pra / high_major | 4,308 | de-vig power / conditional | -0.0167 | -0.0312 to -0.0023 | 350 games | 55.3% | demonstrated deficit |
| player_points_rebounds / high_major | 2,720 | de-vig proportional / conditional | -0.0080 | -0.0243 to +0.0083 | 293 athletes | 99.7% | no demonstrated edge |
| player_points_assists / high_major | 2,228 | de-vig proportional / conditional | -0.0140 | -0.0329 to +0.0050 | 254 athletes | 99.7% | no demonstrated edge |
| player_rebounds_assists / high_major | 2,134 | de-vig power / conditional | -0.0015 | -0.0252 to +0.0223 | 44 days | 99.8% | no demonstrated edge |
| player_points / mid_major | 13,038 | de-vig proportional / conditional | -0.0049 | -0.0168 to +0.0069 | 124 days | 29.4% | no demonstrated edge |
...
| player_steals / mid_major | 6,364 | de-vig proportional / conditional | +0.0022 | -0.0078 to +0.0121 | 103 days | 95.5% | no demonstrated edge |
| player_turnovers / mid_major | 6,442 | de-vig power / conditional | -0.0089 | -0.0202 to +0.0024 | 103 days | 100.0% | no demonstrated edge |
| player_pra / mid_major | 7,252 | de-vig proportional / conditional | -0.0089 | -0.0204 to +0.0026 | 124 days | 50.6% | no demonstrated edge |
| player_points_rebounds / mid_major | 4,846 | de-vig proportional / conditional | -0.0061 | -0.0204 to +0.0083 | 60 days | 99.8% | no demonstrated edge |
| player_points_assists / mid_major | 4,370 | de-vig proportional / conditional | -0.0072 | -0.0208 to +0.0065 | 60 days | 99.9% | no demonstrated edge |
| player_rebounds_assists / mid_major | 4,012 | de-vig proportional / conditional | -0.0032 | -0.0182 to +0.0117 | 356 games | 100.0% | no demonstrated edge |
...
| player_rebounds / low_major | 288 | de-vig power / conditional | -0.0119 | -0.0709 to +0.0471 | 95 athletes | 42.8% | no demonstrated edge |
...
|:---|:---|:---|---:|---:|:---|:---|
| player_props_vs_devig | player_points / high_major | lower | 9,612 | -0.0036 | -0.0246 to +0.0174 | no demonstrated edge |
| player_props_vs_devig | player_points / mid_major | lower | 13,038 | -0.0049 | -0.0168 to +0.0069 | no demonstrated edge |
...
| player_props_vs_devig | player_rebounds / high_major | lower | 7,400 | -0.0045 | -0.0175 to +0.0085 | no demonstrated edge |
| player_props_vs_devig | player_rebounds / mid_major | lower | 10,954 | -0.0039 | -0.0134 to +0.0057 | no demonstrated edge |
| player_props_vs_devig | player_rebounds / low_major | lower | 288 | -0.0119 | -0.0709 to +0.0471 | no demonstrated edge |
...
| player_props_vs_devig | player_threes / high_major | lower | 4,304 | -0.0112 | -0.0271 to +0.0048 | no demonstrated edge |
...
| player_props_vs_devig | player_pra / high_major | lower | 4,308 | -0.0167 | -0.0312 to -0.0023 | demonstrated deficit |
| player_props_vs_devig | player_pra / mid_major | lower | 7,252 | -0.0089 | -0.0204 to +0.0026 | no demonstrated edge |
| player_props_vs_devig | player_pra / low_major | lower | 164 | — | — | not enough evidence (164 wagers, below the 200 declared in advance) |
| player_props_vs_devig | player_steals / high_major | lower | 3,720 | +0.0020 | -0.0118 to +0.0158 | no demonstrated edge |
| player_props_vs_devig | player_steals / mid_major | lower | 6,364 | +0.0022 | -0.0078 to +0.0121 | no demonstrated edge |
| player_props_vs_devig | player_steals / low_major | lower | 190 | — | — | not enough evidence (190 wagers, below the 200 declared in advance) |
| player_props_vs_devig | player_turnovers / high_major | lower | 3,904 | -0.0016 | -0.0157 to +0.0124 | no demonstrated edge |
| player_props_vs_devig | player_turnovers / mid_major | lower | 6,442 | -0.0089 | -0.0202 to +0.0024 | no demonstrated edge |
...
| player_props_vs_devig | player_points_rebounds / high_major | lower | 2,720 | -0.0080 | -0.0243 to +0.0083 | no demonstrated edge |
| player_props_vs_devig | player_points_rebounds / mid_major | lower | 4,846 | -0.0061 | -0.0204 to +0.0083 | no demonstrated edge |
...
| player_props_vs_devig | player_points_assists / high_major | lower | 2,228 | -0.0140 | -0.0329 to +0.0050 | no demonstrated edge |
| player_props_vs_devig | player_points_assists / mid_major | lower | 4,370 | -0.0072 | -0.0208 to +0.0065 | no demonstrated edge |
...
| player_props_vs_devig | player_rebounds_assists / high_major | lower | 2,134 | -0.0015 | -0.0252 to +0.0223 | no demonstrated edge |
| player_props_vs_devig | player_rebounds_assists / mid_major | lower | 4,012 | -0.0032 | -0.0182 to +0.0117 | no demonstrated edge |
...
| player_props_vs_role_prior | high_major | lower | 46,370 | +0.1130 | +0.0656 to +0.1603 | demonstrated edge |
| player_props_vs_role_prior | mid_major | lower | 74,174 | +0.1154 | +0.0912 to +0.1395 | demonstrated edge |
| player_props_vs_role_prior | low_major | lower | 2,060 | +0.0449 | -0.0367 to +0.1265 | no demonstrated edge |
...
|:---|:---|---:|:---|:---|
| high_major | conditional | -0.0025 | -0.0108 to +0.0058 | no demonstrated edge |
| high_major | unconditional | -0.0025 | -0.0109 to +0.0058 | no demonstrated edge |
| mid_major | conditional | -0.0013 | -0.0070 to +0.0044 | no demonstrated edge |
| mid_major | unconditional | -0.0013 | -0.0070 to +0.0044 | no demonstrated edge |
| low_major | conditional | -0.0032 | -0.0353 to +0.0290 | no demonstrated edge |
| low_major | unconditional | -0.0032 | -0.0353 to +0.0290 | no demonstrated edge |
