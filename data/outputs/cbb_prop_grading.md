...
|:---|---:|:---|:---|---:|---:|---:|:---|
| de-vig proportional / conditional | -0.0057 | -0.0103 to -0.0012 | -0.0141 to +0.0026 | 46,370 | 106 days | ±0.0083 | no demonstrated edge |
| **de-vig proportional / unconditional — HEADLINE, least favourable to the model** | -0.0057 | -0.0103 to -0.0012 | -0.0141 to +0.0026 | 46,370 | 106 days | ±0.0083 | no demonstrated edge |
| de-vig power / conditional | -0.0055 | -0.0102 to -0.0007 | -0.0141 to +0.0031 | 46,370 | 106 days | ±0.0086 | no demonstrated edge |
| de-vig power / unconditional | -0.0055 | -0.0102 to -0.0007 | -0.0141 to +0.0031 | 46,370 | 106 days | ±0.0086 | no demonstrated edge |
| control / conditional | +0.1130 | +0.0863 to +0.1396 | +0.0646 to +0.1613 | 46,370 | 541 athletes | ±0.0483 | demonstrated edge |
| control / unconditional | +0.1130 | +0.0863 to +0.1396 | +0.0646 to +0.1613 | 46,370 | 541 athletes | ±0.0483 | demonstrated edge |
...
| de-vig power / conditional | -0.0044 | -0.0076 to -0.0012 | -0.0102 to +0.0015 | 74,174 | 124 days | ±0.0059 | no demonstrated edge |
| de-vig power / unconditional | -0.0044 | -0.0076 to -0.0012 | -0.0102 to +0.0015 | 74,174 | 124 days | ±0.0059 | no demonstrated edge |
| control / conditional | +0.1154 | +0.1018 to +0.1290 | +0.0907 to +0.1400 | 74,174 | 709 athletes | ±0.0247 | demonstrated edge |
| control / unconditional | +0.1154 | +0.1018 to +0.1290 | +0.0907 to +0.1400 | 74,174 | 709 athletes | ±0.0247 | demonstrated edge |
...
| Comparison | Advantage (baseline − model log loss) | 95% interval | Family-corrected | Wagers | Clusters | Could detect | Reading |
|:---|---:|:---|:---|---:|---:|---:|:---|
| de-vig proportional / conditional | -0.0058 | -0.0238 to +0.0123 | -0.0384 to +0.0269 | 2,060 | 101 athletes | ±0.0327 | no demonstrated edge |
| de-vig proportional / unconditional | -0.0058 | -0.0238 to +0.0123 | -0.0384 to +0.0269 | 2,060 | 101 athletes | ±0.0327 | no demonstrated edge |
| **de-vig power / conditional — HEADLINE, least favourable to the model** | -0.0065 | -0.0246 to +0.0116 | -0.0394 to +0.0264 | 2,060 | 101 athletes | ±0.0329 | no demonstrated edge |
| de-vig power / unconditional | -0.0065 | -0.0246 to +0.0116 | -0.0394 to +0.0264 | 2,060 | 101 athletes | ±0.0329 | no demonstrated edge |
| control / conditional | +0.0449 | -0.0010 to +0.0908 | -0.0384 to +0.1282 | 2,060 | 101 athletes | ±0.0833 | no demonstrated edge |
| control / unconditional | +0.0449 | -0.0010 to +0.0908 | -0.0384 to +0.1282 | 2,060 | 101 athletes | ±0.0833 | no demonstrated edge |
...
|:---|---:|:---|---:|:---|---:|---:|:---|
| player_points / high_major | 9,612 | de-vig proportional / unconditional | -0.0036 | -0.0250 to +0.0179 | 106 days | 33.7% | no demonstrated edge |
...
| player_steals / high_major | 3,720 | de-vig proportional / conditional | +0.0020 | -0.0121 to +0.0161 | 298 games | 89.0% | no demonstrated edge |
| player_turnovers / high_major | 3,904 | de-vig power / conditional | -0.0016 | -0.0159 to +0.0127 | 361 athletes | 100.0% | no demonstrated edge |
...
| player_points_assists / high_major | 2,228 | de-vig proportional / conditional | -0.0140 | -0.0333 to +0.0054 | 254 athletes | 99.7% | no demonstrated edge |
| player_rebounds_assists / high_major | 2,134 | de-vig power / conditional | -0.0015 | -0.0257 to +0.0228 | 44 days | 99.8% | no demonstrated edge |
...
| player_assists / mid_major | 9,666 | de-vig proportional / conditional | -0.0011 | -0.0128 to +0.0106 | 673 games | 49.7% | no demonstrated edge |
| player_threes / mid_major | 7,230 | de-vig power / conditional | -0.0082 | -0.0192 to +0.0029 | 667 games | 50.4% | no demonstrated edge |
| player_steals / mid_major | 6,364 | de-vig proportional / conditional | +0.0022 | -0.0080 to +0.0123 | 103 days | 95.5% | no demonstrated edge |
| player_turnovers / mid_major | 6,442 | de-vig power / conditional | -0.0089 | -0.0204 to +0.0027 | 103 days | 100.0% | no demonstrated edge |
| player_pra / mid_major | 7,252 | de-vig proportional / conditional | -0.0089 | -0.0207 to +0.0028 | 124 days | 50.6% | no demonstrated edge |
...
| player_points_assists / mid_major | 4,370 | de-vig proportional / conditional | -0.0072 | -0.0211 to +0.0068 | 60 days | 99.9% | no demonstrated edge |
...
| player_rebounds / low_major | 288 | de-vig power / conditional | -0.0119 | -0.0721 to +0.0484 | 95 athletes | 42.8% | no demonstrated edge |
...
|:---|:---|:---|---:|---:|:---|:---|
| player_props_vs_devig | player_points / high_major | lower | 9,612 | -0.0036 | -0.0250 to +0.0179 | no demonstrated edge |
...
| player_props_vs_devig | player_rebounds / low_major | lower | 288 | -0.0119 | -0.0721 to +0.0484 | no demonstrated edge |
| player_props_vs_devig | player_assists / high_major | lower | 6,040 | -0.0054 | -0.0220 to +0.0113 | no demonstrated edge |
| player_props_vs_devig | player_assists / mid_major | lower | 9,666 | -0.0011 | -0.0128 to +0.0106 | no demonstrated edge |
...
| player_props_vs_devig | player_threes / mid_major | lower | 7,230 | -0.0082 | -0.0192 to +0.0029 | no demonstrated edge |
...
| player_props_vs_devig | player_pra / mid_major | lower | 7,252 | -0.0089 | -0.0207 to +0.0028 | no demonstrated edge |
| player_props_vs_devig | player_pra / low_major | lower | 164 | — | — | not enough evidence (164 wagers, below the 200 declared in advance) |
| player_props_vs_devig | player_steals / high_major | lower | 3,720 | +0.0020 | -0.0121 to +0.0161 | no demonstrated edge |
...
| player_props_vs_devig | player_turnovers / high_major | lower | 3,904 | -0.0016 | -0.0159 to +0.0127 | no demonstrated edge |
| player_props_vs_devig | player_turnovers / mid_major | lower | 6,442 | -0.0089 | -0.0204 to +0.0027 | no demonstrated edge |
...
| player_props_vs_devig | player_points_assists / high_major | lower | 2,228 | -0.0140 | -0.0333 to +0.0054 | no demonstrated edge |
| player_props_vs_devig | player_points_assists / mid_major | lower | 4,370 | -0.0072 | -0.0211 to +0.0068 | no demonstrated edge |
...
| player_props_vs_devig | player_rebounds_assists / high_major | lower | 2,134 | -0.0015 | -0.0257 to +0.0228 | no demonstrated edge |
...
| player_props_vs_role_prior | high_major | lower | 46,370 | +0.1130 | +0.0646 to +0.1613 | demonstrated edge |
| player_props_vs_role_prior | mid_major | lower | 74,174 | +0.1154 | +0.0907 to +0.1400 | demonstrated edge |
| player_props_vs_role_prior | low_major | lower | 2,060 | +0.0449 | -0.0384 to +0.1282 | no demonstrated edge |
...
|:---|:---|---:|:---|:---|
| high_major | conditional | -0.0025 | -0.0110 to +0.0060 | no demonstrated edge |
| high_major | unconditional | -0.0025 | -0.0110 to +0.0060 | no demonstrated edge |
