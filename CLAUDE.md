...
*Generated by `scripts/splice_headline_table.py` from `data/outputs/cbb_price_backtest.json` at the ledger's 101 hypotheses. Do not edit between the markers; re-run the script.*
...
-0.1% [@62]; it crosses zero at the 85th hypothesis and reads **no demonstrated edge** at today's 101 — the interval is in the
...
deficit at -12.5% to -0.2% [@62] at those same 62 hypotheses and reads **no
