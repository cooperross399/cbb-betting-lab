...
(-0.0102 to +0.0011) and **-0.0065** (-0.0387 to +0.0257). Uncorrected, the
...
-6.4% over 8,214 bets, corrected -12.7% to +0.0% at those same 95 and
**-12.8% to +0.0% at today's 101**; it crossed at the **95th** — the last
