...
push conventions, is **-0.0055** (corrected -0.0139 to +0.0029), **-0.0044**
(-0.0101 to +0.0013) and **-0.0065** (-0.0387 to +0.0257). Uncorrected, the
...
deficit — `player_pra` / high-major at -0.0167, corrected -0.0312 to -0.0023
...
+0.0656 to +0.1603) and mid-major (+0.1154, +0.0912 to +0.1395), which says its
...
family-corrected one at the experiment ledger's **cumulative count of 101
distinct hypotheses, ×1.7773** — the same correction every generated report in
...
since reached **101**, ×1.7773, with the forward window and the rebound
...
demonstrated deficit**: -4.0% over 59,475 bets, corrected -8.1% to +0.0% at
those 95 hypotheses and **-8.1% to +0.1% at today's 101**, having crossed zero
at the 85th. So is the replication's held-out `total_points` / mid-major cell,
-6.4% over 8,214 bets, corrected -12.7% to +0.0% at 95 hypotheses and
**-12.8% to +0.0% at 101 hypotheses**; it crossed at the **95th** — the last
entry of that registration. **Mid-major survives** at -4.3%, corrected -8.2% to
