...
**Family correction: 130 cumulative hypotheses, x1.8115.** Every interval below is widened by it. The count is the experiment ledger's cumulative total, not the day's.
...
|:---|:---|---:|:---|:---|
| forecast skill | high_major Brier vs raw | -0.01663 | -0.02210 to -0.01116 | demonstrated deficit |
| forecast skill | high_major disagreement | +0.08759 | -0.04814 to +0.22332 | no demonstrated edge |
| forecast skill | low_major Brier vs raw | -0.00776 | -0.01111 to -0.00441 | demonstrated deficit |
| forecast skill | low_major disagreement | +0.04630 | -0.15274 to +0.24534 | no demonstrated edge |
| forecast skill | mid_major Brier vs raw | -0.00962 | -0.01328 to -0.00596 | demonstrated deficit |
| forecast skill | mid_major disagreement | +0.12189 | -0.03306 to +0.27685 | no demonstrated edge |
| forecast skill | selected-bets disagreement | +0.23943 | +0.00311 to +0.47575 | demonstrated edge |
| prop grading | high_major de-vig headline | -0.00548 | -0.01405 to +0.00309 | no demonstrated edge |
| prop grading | high_major role-prior control | +0.11296 | +0.06473 to +0.16120 | demonstrated edge |
| prop grading | low_major de-vig headline | -0.00651 | -0.03933 to +0.02632 | no demonstrated edge |
| prop grading | low_major role-prior control | +0.04490 | -0.03831 to +0.12811 | no demonstrated edge |
| prop grading | mid_major de-vig headline | -0.00439 | -0.01023 to +0.00145 | no demonstrated edge |
| prop grading | mid_major role-prior control | +0.11537 | +0.09074 to +0.14000 | demonstrated edge |
| prop grading | player_pra high-major | -0.01674 | -0.03150 to -0.00199 | demonstrated deficit |
| replication | total_points mid-major held out | -0.06364 | -0.12883 to +0.00154 | no demonstrated edge |

*Generated by `scripts/splice_headline_table.py` from the records in `data/outputs/` at the ledger's 130 hypotheses. Do not edit between the markers; re-run the script.*
