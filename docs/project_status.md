...
| 21 | `docs/decision_log.md` and `docs/ported_defects.md` complete | **done** | 42 decisions, **26 defect classes** (A-Z) with the regression test for each. S-W are the ladders-and-halves rebuild that died before persistence and cost 1,199,926 credits; decision 27 is Cooper's call not to re-buy it, with the number attached. |
