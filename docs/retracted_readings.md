...
| today | c8f902d | `core_team_only/cbb_price_backtest.json` / null_baseline / high_major / spread / always away | -0.03310 | 0.01262 | 15,267 | 2.62 | 130 | 6 | no demonstrated edge | no |
...
| today | c8f902d | `core_team_only/cbb_price_backtest.json` / null_baseline / low_major / spread / always away | -0.03779 | 0.01066 | 21,393 | 3.54 | 130 | 127 | no demonstrated edge | no |
...
| today | c8f902d | `core_team_only/cbb_price_backtest.json` / null_baseline / low_major / spread / always home | -0.02985 | 0.01065 | 21,393 | 2.80 | 130 | 10 | no demonstrated edge | no |
...
| today | c8f902d | `core_team_only/cbb_price_backtest.json` / null_baseline / low_major / spread / always the favourite | -0.07419 | 0.02285 | 1,220 | 3.25 | 130 | 43 | no demonstrated edge | no |
...
| today | c8f902d | `core_team_only/cbb_price_backtest.json` / null_baseline / low_major / team_total / always over | -0.03335 | 0.01238 | 14,552 | 2.69 | 130 | 8 | no demonstrated edge | no |
...
| today | c8f902d | `holdout/cbb_price_backtest.json` / null_baseline / high_major / player_assists / always the underdog | — | — | — | — | — | — | not in the record | no |
...
| today | c8f902d | `holdout/cbb_price_backtest.json` / null_baseline / high_major / player_rebounds / always the favourite | — | — | — | — | — | — | not in the record | no |
...
| today | c8f902d | `holdout/cbb_price_backtest.json` / null_baseline / high_major / spread / always away | -0.04685 | 0.01590 | 9,047 | 2.95 | 130 | 16 | no demonstrated edge | no |
...
| today | c8f902d | `holdout/cbb_price_backtest.json` / null_baseline / mid_major / player_rebounds_assists / always the favourite | — | — | — | — | — | — | not in the record | no |
...
| today | c8f902d | `holdout/cbb_price_backtest.json` / null_baseline / mid_major / player_threes / always the underdog | — | — | — | — | — | — | not in the record | no |
