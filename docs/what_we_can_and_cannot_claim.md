...
- Generated: 2026-09-15T15:04:56+00:00
...
**128 distinct hypotheses have ever been tested here**, and every interval below is widened by **x1.81** before it means what it says. That is the ledger's **cumulative** count and never the day's: *a search that runs every week is not twelve tests, it is twelve tests a week, forever.*
...
|:---|:---|:---|---:|---:|---:|:---|:---|:---|:---|
| `alternate_spread` | high_major | bets | 2,551 | 70 games | -10.4% | -33.0% to +12.2% | -51.3% to +30.5% | no held-out test has been run | no demonstrated edge |
| `alternate_total_points` | high_major | bets | 2,114 | 64 games | -1.1% | -31.0% to +28.7% | -55.1% to +52.8% | no held-out test has been run | no demonstrated edge |
...
| `spread_h1` | high_major | bets | 223 | 72 games | -24.7% | -47.9% to -1.5% | -66.7% to +17.3% | no held-out test has been run | no demonstrated edge |
...
| `alternate_total_points` | mid_major | bets | 7,467 | 230 games | -17.0% | -29.7% to -4.2% | -40.1% to +6.1% | no held-out test has been run | no demonstrated edge |
...
| `alternate_total_points` | low_major | bets | 3,785 | 121 games | -10.5% | -30.3% to +9.4% | -46.3% to +25.4% | no held-out test has been run | no demonstrated edge |
...
| `spread_h1` | low_major | bets | 405 | 121 games | +5.0% | -14.9% to +25.0% | -31.0% to +41.1% | no held-out test has been run | no demonstrated edge |
...
| `total_points` | low_major | bets | 17,903 | 7,131 games | -5.2% | -7.5% to -2.8% | -9.5% to -0.9% | nothing to replicate on the 2025, 2026 (held out) window | demonstrated deficit |
...
Sized to **demonstrate** the edge, not merely to observe it: at 80% power and at the ledger's 128 cumulative hypotheses. An earlier version of this table gave the uncorrected 50%-power figure — the sample at which an interval just excludes zero when the observed effect happens to equal the true one — which understated a +5% edge by 4.8x.
