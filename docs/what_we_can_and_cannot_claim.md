...
- Generated: 2026-09-05T19:16:02+00:00
...
**95 distinct hypotheses have ever been tested here**, and every interval below is widened by **x1.77** before it means what it says. That is the ledger's **cumulative** count and never the day's: *a search that runs every week is not twelve tests, it is twelve tests a week, forever.*
...
|:---|:---|:---|---:|---:|---:|:---|:---|:---|:---|
| `alternate_spread` | high_major | bets | 2,551 | 70 games | -10.4% | -33.0% to +12.2% | -50.4% to +29.6% | no held-out test has been run | no demonstrated edge |
| `alternate_total_points` | high_major | bets | 2,114 | 64 games | -1.1% | -31.0% to +28.7% | -53.9% to +51.6% | no held-out test has been run | no demonstrated edge |
...
| `spread_h1` | high_major | bets | 223 | 72 games | -24.7% | -47.9% to -1.5% | -65.8% to +16.4% | no held-out test has been run | no demonstrated edge |
...
| `alternate_spread` | mid_major | bets | 9,319 | 93 days | -3.4% | -13.9% to +7.1% | -22.1% to +15.2% | no held-out test has been run | no demonstrated edge |
...
| `alternate_total_points` | mid_major | bets | 7,467 | 230 games | -17.0% | -29.7% to -4.2% | -39.6% to +5.6% | no held-out test has been run | no demonstrated edge |
...
| `spread_h1` | mid_major | bets | 799 | 238 games | -7.4% | -21.2% to +6.5% | -31.9% to +17.1% | no held-out test has been run | no demonstrated edge |
...
| `total_points_h1` | mid_major | bets | 594 | 202 games | -2.4% | -17.4% to +12.6% | -28.9% to +24.2% | no held-out test has been run | no demonstrated edge |
| `alternate_spread` | low_major | bets | 3,510 | 127 games | -2.1% | -19.2% to +15.0% | -32.4% to +28.2% | no held-out test has been run | no demonstrated edge |
...
| `alternate_total_points` | low_major | bets | 3,785 | 121 games | -10.5% | -30.3% to +9.4% | -45.5% to +24.6% | no held-out test has been run | no demonstrated edge |
...
| `spread_h1` | low_major | bets | 405 | 121 games | +5.0% | -14.9% to +25.0% | -30.2% to +40.3% | no held-out test has been run | no demonstrated edge |
...
| `total_points_h1` | low_major | bets | 326 | 106 games | -11.4% | -32.3% to +9.5% | -48.3% to +25.6% | no held-out test has been run | no demonstrated edge |
